        ...
        <div class="row">
          <div class="col-md-12">
            <div class="breadcrumb-wrapper">
              <h2 class="page-title">Applicant's WeWork Profile</h2>
            </div>
          </div>
        </div>
      </div>
...
$sql = "SELECT first_name FROM user_detail WHERE id='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
 ...
 ?>
 		...
 		<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `last_name` FROM `user_detail` WHERE `id`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `date_of_birth` FROM `user_detail` WHERE `id`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `nationality` FROM `user_detail` WHERE `id`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `gender` FROM `user_detail` WHERE `id`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `address1` FROM `userdetail` WHERE `userdetailid`='$userdetailid";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php
$sql = "SELECT `address2` FROM `userdetail` WHERE `userdetailid`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `city` FROM `userdetail` WHERE `userdetailid`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;font-style: italic;">
				<?php 
$sql = "SELECT `state` FROM `userdetail` WHERE `userdetailid`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;">
				<?php 
$sql = "SELECT `zip` FROM `userdetail` WHERE `userdetailid`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;">
				<?php 
$sql = "SELECT `skills` FROM `userdetail` WHERE `userdetailid`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
...
<tr>
			...
			<i><td style="font-size: 15px;text-align:right;padding:10px;">
				<?php 
$sql = "SELECT `language` FROM `userdetail` WHERE `userdetailid`='$userdetailid'";
$result = mysqli_query($db,$sql);
if ($result->num_rows > 0) {
    // output data of each row
    while($row = $result->fetch_assoc()) {
